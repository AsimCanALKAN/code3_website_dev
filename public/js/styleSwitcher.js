...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'dark'){
            jQuery(".mm-collapse").attr('style',  'background-color:#212130');
            jQuery(".list").attr('style',  'background-color:#212130');
            jQuery(".option").attr('style',  'background-color:#212130');
            $(function() {
                $('.option').hover( function(){
                   $(this).css('background-color', '#212130');
                },
                function(){
                   $(this).css('background-color', '#212130');
                });
             });
            jQuery(".option").attr('style',  'color:#ffffff');
            jQuery(".sidebar-right-inner").attr('style',  'background-color:#212130');
            ...
            jQuery(".mm-collapse").attr('style',  'background-color:#ffffff');
            jQuery(".list").attr('style',  'background-color:#ffffff');
            jQuery(".option").attr('style',  'background-color:#ffffff');
            jQuery(".option").attr('style',  'color:#212130');
            $(function() {
                $('.option').hover( function(){
            ...
            jQuery(".sidebar-right-inner").attr('style',  'background-color:#ffffff');
