    ...
    async function showTableData(data) {
        ...
        for (var i = 0; i < data.transactions.length; i++) {
            ...
            if (transactionRowId) {
                ...
                var secondModalCollapsableDiv = document.getElementById("modalStrategyTradeSettings" + data.transactions[i].id);
                ...
                transactionRowId.innerHTML = ` 
                                    <td style="border-color: transparent;">
                                        <div class="dropdown dropstart">
                                            ...
                                            <!-- Modal -->
                                            <div class="${modalValueActions}" id="modalStrategyTradeSettings${data.transactions[i].id}" style="${modalValuestyle}">
                                                ${await strategyModalSettings(data.transactions[i].id, data.transactions[i].strategy_id, modalValueActions, modalValuestyle)}
                                            </div>
                                    ...
                                    <td data-bs-toggle="collapse" data-bs-target="#default_collapse${data.transactions[i].id}" class="accordion-header collapsed" style="border-color: transparent;">${await positionTypeTransaction(data.transactions[i].positions[data.transactions[i].positions.length -1].type, data.transactions[i].positions.length)}</td>
                                    <td data-bs-toggle="collapse" data-bs-target="#default_collapse${data.transactions[i].id}" class="accordion-header collapsed" style="border-color: transparent;">
                                        ${await profitHTML(data.transactions[i].positions[0].profit)}
