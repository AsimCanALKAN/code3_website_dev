...
<script>
    ...
    async function showTableData(data) {
        ...
        for (var i = 0; i < data.transactions.length; i++) {
            transactionTable.append(`                     <tr>
                        <td style="border-color: transparent;">
                            <div class="dropdown dropstart">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a data-bs-toggle="modal" data-bs-target="#modalStrategyTradeSettings${data.transactions[i].id}" class="dropdown-item"><i class="las la-cog scale5 me-3"></i>Strategy Settings</a>
                        ...
                        <td data-bs-toggle="collapse" data-bs-target="#default_collapse${data.transactions[i].id}" class="accordion-header collapsed" style="border-color: transparent;"><span>Broker ${data.transactions[i].broker_id}</span></td>
                        ...
                        <td data-bs-toggle="collapse" data-bs-target="#default_collapse${data.transactions[i].id}" class="accordion-header collapsed" style="border-color: transparent;"><span class="text-nowrap">${data.transactions[i].broker_id}</span></td>
                        <td data-bs-toggle="collapse" data-bs-target="#default_collapse${data.transactions[i].id}" class="accordion-header collapsed" style="border-color: transparent;"><span class="text-nowrap">Step: </span><span style="color:red">3 - Sell ${data.transactions[i].broker_id}</span></td>
    ...
    async function openPositionsTableAdd(dataTransactions) {
        ...
        for (var a = 0; a < dataTransactions.positions.length; a++) {
            if (dataTransactions.positions[a].close_time == "1970-01-01T00:00:00.000Z") {
                returnedVariable = returnedVariable + `
                                                        <tr>
    ...
    async function strategyModalSettings(transactionId, strategyId) {
        ...
        for (var i = 0; i < datas.strategies.length; i++) {
            return `  <div class="modal-dialog modal-dialog-centered" role="document">
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="modalInputs${transactionId}">
                                ${await strategyModalInputs(datas.strategies[i])}
                                </div>`
        }
    }

    async function strategyModalInputs(strategyJSON) {
        return ` <div class="modal-dialog modal-dialog-centered" role="document">
                                        <form>
                                            <div class="modal-content">
                                                <div class="modal-header">
