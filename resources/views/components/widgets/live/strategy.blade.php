<div class="col-xl-6 col-xxl-12">
    <div class="card">
        <div class="card-header d-block d-sm-flex border-0">
            <div class="me-3">
                <h4 class="card-title mb-2">Live BreakOut Strategy</h4>
                <span class="fs-12">You can see your working programs</span>
            </div>
            <div class="card-tabs mt-3 mt-sm-0">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#transaction" role="tab">in Transaction</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#pending" role="tab">Pending</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#boarding" role="tab">Boarding</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <table class="table table-responsive-md card-table transactions-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);" class="text-black">{{ $strategy['pair'] }}-{{ $strategy['magic'] }}</a></h6>
                                    <span class="fs-14">{{ $strategy['broker'] }}</span>
                                </td>
                                <td>
                                    <h6 class="fs-16 text-black font-w600 mb-0">{{ $strategy['date'] }}</h6>
                                    <span class="fs-14">{{ $strategy['time'] }}</span>
                                </td>
                                <td><span class="fs-16 text-black font-w600">{{ $strategy['profit'] }}</span></td>
                                <td><span class="text-secondary fs-16 font-w500 text-end d-block">{{ $strategy['status'] }}</span></td>
                            </tr> 
                            @endforeach
                        </tbody>
                    </table>
                    ...
                    <table class="table table-responsive-md card-table transactions-table">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);" class="text-black">USDJPY-6666</a></h6>
                                    <span class="fs-14">Alchemy-209123</span>
                                </td>
                                <td>
                                ...
                                <td><span class="text-secondary fs-16 font-w500 text-end d-block">in Transaction</span></td>
                            </tr>
                            <tr>
                                <td>
                                    <svg class="bgl-danger tr-icon" width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <td>
                                    <h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);" class="text-black">EURUSD-444</a></h6>
                                    <span class="fs-14">Alchemy-209123</span>
                                </td>
                                <td>
                    ...
                    <table class="table table-responsive-md card-table transactions-table">
                        <tbody>
                            <tr>
                                ...
                                <td><span class="fs-16 text-black font-w600">$0</span></td>
                    ...
                    <table class="table table-responsive-md card-table transactions-table">
                        <tbody>
                            <tr>
                                ...
                                <td><span class="fs-16 text-black font-w600">$0</span></td>
                                <td><span class="text-info fs-16 font-w500 text-end d-block">Boarding</span></td>
                            </tr>
                            <tr>
                                <td>
                                    <svg class="bgl-danger tr-icon" width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
