...
<script>
    ...
    function httpGet(theUrl, selectObject, selectLoading) {
        var baseUrl = "{{ route('api.history.services') }}" + "?theUrl=" + theUrl;
    ...
    async function filterButtonClicked() {
        ...
        var dateTimeRangeSelectFilterValue = document.getElementById("datetime_range").value;
        var startTimeSelectFilterValue = document.getElementById("start_time").value;
        var endTimeSelectFilterValue = document.getElementById("end_time").value;
        var datetimeTimeRange = dateTimeRangeSelectFilterValue.split(" - ");
        var startDate = datetimeTimeRange[0] + " " + startTimeSelectFilterValue;
        var endDate = datetimeTimeRange[1] + " " + endTimeSelectFilterValue;
        var endpointPath = "?start_time=" + startDate + "&end_time=" + endDate + "&min_profit=" + minProfitSelectFilterValue + "&max_profit=" + maxProfitSelectFilterValue + "&min_step=" + minStepSelectFilterValue + "&max_step=" + maxStepSelectFilterValue;
    ...
    async function showTableData(data) {
        ...
        if (data.transactions.length === 0) {
            ...
            document.getElementById("historyTransactions").scrollIntoView();
            return;
        }
